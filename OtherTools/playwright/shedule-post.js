...
(async () => {
  ...
  for (const browserType of ['chromium']){//, 'firefox', 'webkit']) {
	...
	await page.screenshot({path: './img/schedule_post_04.png'})
	
	//When I click publish
	await page.click('.gh-publishmenu-trigger')
	await new Promise(r => setTimeout(r, 2000));
	await page.screenshot({path: './img/schedule_post_05.png'})
	
	//When I click a schedule ratio btn
	await page.click('.gh-publishmenu-section > div:nth-child(2) > div:nth-child(1)')
	await new Promise(r => setTimeout(r, 2000));
	await page.screenshot({path: './img/schedule_post_06.png'})
