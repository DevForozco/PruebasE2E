...
(async () => {
  ...
  for (const browserType of ['chromium']){//, 'firefox', 'webkit']) {
	...
	await page.screenshot({path: 'comparativeReport/screenshots/ref-3.3/edit_post_01.png'})

	//When I click login
	await page.click(pageObject.login.loginBtn)
	await new Promise(r => setTimeout(r, 2000))
	await page.screenshot({path: 'comparativeReport/screenshots/ref-3.3/edit_post_02.png'})

	await page.goto(nodes.urlPost)
	await new Promise(r => setTimeout(r, 2000))
	await page.screenshot({path: 'comparativeReport/screenshots/ref-3.3/edit_post_03.png'})
	...
	await page.screenshot({path: 'comparativeReport/screenshots/ref-3.3/edit_post_04.png'})
	...
	await page.screenshot({path: 'comparativeReport/screenshots/ref-3.3/edit_post_08.png'})
	...
	await page.goto(nodes.urlPublished)
	await new Promise(r => setTimeout(r, 2000))
	await page.screenshot({path: 'comparativeReport/screenshots/ref-3.3/edit_post_11.png'})
