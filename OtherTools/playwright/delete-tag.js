...
(async () => {
  ...
  for (const browserType of ['chromium']){//, 'firefox', 'webkit']) {
    ...
    await page.screenshot({path: 'comparativeReport/screenshots/ref-3.3/delete_tag_0.png'})
    ...
    await new Promise(r => setTimeout(r, 7000));
    await page.screenshot({path: 'comparativeReport/screenshots/ref-3.3/delete_tag_1.png'})
    await page.click('#ember12')
    await new Promise(r => setTimeout(r, 9000));
    await page.screenshot({path: 'comparativeReport/screenshots/ref-3.3/delete_tag_2.png'})

    await page.click(".gh-nav-list > li:nth-child(4)");
    await page.screenshot({path: 'comparativeReport/screenshots/ref-3.3/delete_tag_3.png'});

    await new Promise(r => setTimeout(r, 2000));
    await page.click(".view-actions > a:nth-child(2)");
    await page.screenshot({path: 'comparativeReport/screenshots/ref-3.3/delete_tag_4.png'});
    ...
    await new Promise(r => setTimeout(r, 2000));
    await page.click(".gh-nav-list > li:nth-child(4)");
    await page.screenshot({path: 'comparativeReport/screenshots/ref-3.3/delete_tag_6.png'});

    await new Promise(r => setTimeout(r, 2000));
    await page.click(".tags-list:last-child");
    await page.screenshot({path: 'comparativeReport/screenshots/ref-3.3/delete_tag_7.png'});

    await new Promise(r => setTimeout(r, 2000));
    await page.click(".gh-btn.gh-btn-red");
    await page.screenshot({path: 'comparativeReport/screenshots/ref-3.3/delete_tag_8.png'});

    await new Promise(r => setTimeout(r, 2000));
    await page.click(".modal-footer > button:nth-child(2)");
    await new Promise(r => setTimeout(r, 2000));
    await page.screenshot({path: 'comparativeReport/screenshots/ref-3.3/delete_tag_9.png'});
