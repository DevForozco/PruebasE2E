...
(async () => {
  ...
  for (const browserType of ['chromium']){//, 'firefox', 'webkit']) {
    ...
    await page.screenshot({path: './edit_email_staff_0.png'})
    ...
    await new Promise(r => setTimeout(r, 7000));
    await page.screenshot({path: './edit_email_staff_1.png'})
    await page.click('#ember12')
    await new Promise(r => setTimeout(r, 5000));
    await page.screenshot({path: './edit_email_staff_2.png'});

    await new Promise(r => setTimeout(r, 3000));
    await page.click('.gh-nav-list > li:nth-child(5)');
    await page.screenshot({path: './edit_email_staff_3.png'});

    await new Promise(r => setTimeout(r, 3000));
    await page.click('.apps-grid > div:nth-child(3) > a');
    await page.screenshot({path: './edit_email_staff_4.png'});

    await new Promise(r => setTimeout(r, 3000));
    await page.fill('#user-email', ' ');
    await page.screenshot({path: './edit_email_staff_5.png'});

    await new Promise(r => setTimeout(r, 3000));
    await page.click('.gh-btn.gh-btn-blue');
    await page.screenshot({path: './edit_email_staff_6.png'});
