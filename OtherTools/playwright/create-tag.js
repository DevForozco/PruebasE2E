...
(async () => {
  ...
  for (const browserType of ["chromium"]) {
    ...
    await page.screenshot({
      path: "comparativeReport/screenshots/ref-3.3/create_tag_1.png",
    });
    await page.click(pageObject.login.loginBtn);
    await new Promise((r) => setTimeout(r, 9000));
    await page.screenshot({
      path: "comparativeReport/screenshots/ref-3.3/create_tag_2.png",
    });

    await page.click(".gh-nav-list > li:nth-child(4)");
    await page.screenshot({
      path: "comparativeReport/screenshots/ref-3.3/create_tag_3.png",
    });

    await new Promise((r) => setTimeout(r, 2000));
    await page.click(".view-actions > a:nth-child(2)");
    await page.screenshot({
      path: "comparativeReport/screenshots/ref-3.3/create_tag_4.png",
    });
    ...
    await page.screenshot({
      path: "comparativeReport/screenshots/ref-3.3/create_tag_5.png",
    });
    ...
    await page.click(".gh-nav-list > li:nth-child(4)");
    await page.screenshot({
      path: "comparativeReport/screenshots/ref-3.3/create_tag_6.png",
    });
