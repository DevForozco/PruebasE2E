...
(async () => {
  ...
  for (const browserType of ['chromium']){//, 'firefox', 'webkit']) {
    ...
    await page.fill(pageObject.login.pssImput, user.password);
  	await page.screenshot({path: 'comparativeReport/screenshots/ref-3.3/create_post_01.png'})

  	//When I click login
  	await page.click(pageObject.login.loginBtn)
	await new Promise(r => setTimeout(r, 2000));
  	await page.screenshot({path: 'comparativeReport/screenshots/ref-3.3/create_post_02.png'})

  	await page.goto(nodes.urlPost)
	await new Promise(r => setTimeout(r, 2000));
	await page.screenshot({path: 'comparativeReport/screenshots/ref-3.3/create_post_03.png'})
	...
	await new Promise(r => setTimeout(r, 2000));
  	...
  	await page.screenshot({path: 'comparativeReport/screenshots/ref-3.3/create_post_04.png'})

  	//When I click publish
  	await page.click(pageObject.post.publishBtn)
	await new Promise(r => setTimeout(r, 2000));
	await page.screenshot({path: 'comparativeReport/screenshots/ref-3.3/create_post_05.png'})

  	//When I click publish now
  	await page.click('.gh-publishmenu-button')
	await new Promise(r => setTimeout(r, 2000));
	await page.screenshot({path: 'comparativeReport/screenshots/ref-3.3/create_post_06.png'})
