...
(async () => {
  ...
  for (const browserType of ['chromium']){//, 'firefox', 'webkit']) {
    ...
    await page.screenshot({path: './create_internal_tag_0.png'})
    ...
    await new Promise(r => setTimeout(r, 7000));
    await page.screenshot({path: './create_internal_tag_1.png'})
    await page.click('#ember12')
    await new Promise(r => setTimeout(r, 9000));
    await page.screenshot({path: './create_internal_tag_2.png'})
    
    await page.click(".gh-nav-list > li:nth-child(4)");
    await page.screenshot({path: './create_internal_tag_3.png'});

    await page.click(".view-actions > div > button:nth-child(2)");
    await page.screenshot({path: './create_internal_tag_4.png'});
    
    await new Promise(r => setTimeout(r, 2000));
    await page.click(".view-actions > a:nth-child(2)");
    await page.screenshot({path: './create_internal_tag_5.png'});
    ...
    await page.screenshot({path: './create_internal_tag_6.png'});
    ...
    await new Promise(r => setTimeout(r, 2000));
    await page.click(".gh-nav-list > li:nth-child(4)");
    await page.screenshot({path: './create_internal_tag_7.png'});
